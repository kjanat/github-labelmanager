...
export const labelNameBase: z.ZodString = z.string()
	...
	.meta({
		title: 'Label Name',
		description: `\
GitHub label name. Maximum 50 characters.
...
export const hexColorBase: z.ZodString = z.string()
	...
	.meta({
		...
		description: `\
Valid CSS hex color code for the label.
...
Use <code>"aliases"</code> to rename existing labels while preserving issue associations.
