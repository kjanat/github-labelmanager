...
export const labelDescriptionBase: z.ZodString = z.string()
	...
	.meta({
		...
		description: "GitHub label description. Maximum 100 characters. Should be concise and explain the label's purpose.",
		examples: [
...
export const labelDefinitionSchema: z.ZodTypeAny = z.strictObject({
	...
	description: 'A GitHub issue label with name, color, description, and optional aliases for renaming.',
});
