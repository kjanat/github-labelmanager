...
export const DEFAULT_SCHEMA_ID = `https://raw.githubusercontent.com/${GIT_REPO}/${GIT_BRANCH}/${OUTPUT_PATH}`;
...
export function generateSchema(): Record<string, unknown> {
	...
	schema.description = `Schema for declaratively managing GitHub issue labels via ${GIT_REPO}.`;
