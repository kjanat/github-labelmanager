...
describe('core fixture coverage', () => {
	const JSON_SOURCE = 'https://cdn.jsdelivr.net/gh/kjanat/github-labelmanager@6dcde0c/.github/labels.schema.json';
	// Plain text file (not JSON) - triggers the catch block in setWebSource
	const TEXT_SOURCE = 'https://cdn.jsdelivr.net/gh/kjanat/github-labelmanager@6dcde0c/README.md';
