	...
	return {
		rest: {
			issues: {
				...
				createComment: mock(() => Promise.resolve({ data: { ...defaultComment } })),
				updateComment: mock(() => Promise.resolve({ data: { ...defaultComment } })),
			},
...
function clearOctokitMocks(): void {
	...
	mockOctokit.rest.issues.listComments.mockImplementation(() => Promise.resolve({ data: [] }));
	mockOctokit.rest.issues.createComment.mockImplementation(() => Promise.resolve({ data: { ...defaultComment } }));
	mockOctokit.rest.issues.updateComment.mockImplementation(() => Promise.resolve({ data: { ...defaultComment } }));
	mockOctokit.rest.pulls.list.mockImplementation(() => Promise.resolve({ data: [] }));
}
